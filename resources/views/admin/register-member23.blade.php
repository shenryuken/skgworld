					...
					<ul>
						...
						<li>
							<a href="#step-2">
								...
								<span class="stepDesc">Step 2<br /><small>Select Products or Packages</small></span>
							</a>
						</li>
						<li>
							<a href="#step-3">
								...
								<div class="panel panel-default">
							        ...
							        <div class="panel-footer">
						                <form>
											...
											<button type="submit" class="btn btn-block btn-danger addtocart">Add to cart</button>
...
<script type="text/javascript">
    ...
    $(".addtocart").click(function(e){
        ...
        $.ajax({
           ...
           data:{itemType:itemType, id:id, quantity:quantity},
